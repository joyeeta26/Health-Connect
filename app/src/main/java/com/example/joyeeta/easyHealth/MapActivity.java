...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(_tBlood){
            ...
            //added
            mMessagesDatabaseReference =mFirebaseDatabase.getReference("Users/"+_state+"/Blood/Count");
            //cRef = new Firebase("https://friendly-chat-4fda9.firebaseio.com/Users/"+_state+"/Blood/Count");
...
//            });
            ...
            cMessagesDatabaseReference = mFirebaseDatabase.getReference("Users/"+_state+"/Blood/Donors");
...
//        map.animateCamera(update);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.addMarker(new MarkerOptions().position(ll).title("Marker in "+_state));
